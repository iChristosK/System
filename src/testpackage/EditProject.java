...
public class EditProject extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        projectQuery = java.beans.Beans.isDesignTime() ? null : kiosPUEntityManager.createQuery("SELECT p FROM Project p");
        ...
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${projectsuper}"));
        columnBinding.setColumnName("Projectsuper");
        columnBinding.setColumnClass(Integer.class);
    ...
    private java.util.List<testpackage.Project> projectList;
